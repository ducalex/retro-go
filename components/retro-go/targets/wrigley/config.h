...
#define RG_SCREEN_WIDTH             300 // screen is technically 280x240 but it works!
...
#define RG_UPDATER_DOWNLOAD_LOCATION    RG_STORAGE_ROOT "/wrigley/firmware"
