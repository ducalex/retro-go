// Target definition
#define RG_TARGET_NAME             "pocketbyte"
...
#define RG_SCREEN_INIT()                                                                                         \
    ...
    ILI9341_CMD(ST7789_MADCTL, (ST7789_MADCTL_MX | ST7789_MADCTL_MY | ST7789_MADCTL_BGR));                                                             \
...
#define RG_GAMEPAD_I2C_MAP {\
    {RG_KEY_UP,     .num = 15,  .pullup = 1, .level = 0},\
    {RG_KEY_RIGHT,  .num = 13,  .pullup = 1, .level = 0},\
    {RG_KEY_DOWN,   .num = 12, .pullup = 1, .level = 0},\
    {RG_KEY_LEFT,   .num = 14, .pullup = 1, .level = 0},\
    {RG_KEY_SELECT, .num = 0, .pullup = 1, .level = 0},\
    {RG_KEY_START,  .num = 11, .pullup = 1, .level = 0},\
    {RG_KEY_MENU,   .num = 8, .pullup = 1, .level = 0},\
    {RG_KEY_OPTION, .num = 0,  .pullup = 1, .level = 0},\
    {RG_KEY_A,      .num = 10, .pullup = 1, .level = 0},\
    {RG_KEY_B,      .num = 9,  .pullup = 1, .level = 0},\
}
...
// SPI SD Card
#define RG_GPIO_SDSPI_MISO          GPIO_NUM_6
#define RG_GPIO_SDSPI_MOSI          GPIO_NUM_8
