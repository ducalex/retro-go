...
## Prerequisites
You will need a working installation of [esp-idf](https://docs.espressif.com/projects/esp-idf/en/release-v5.3/esp32/get-started/index.html#get-started-get-prerequisites). Versions 5.1 to 5.5 are supported.
