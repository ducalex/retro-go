...
"        <label for='upload'><button style='pointer-events: none;'>Upload files</button></label>"
"        <input hidden type='file' id='upload' onchange='upload_files()' multiple><label id='status'>"
"    </div>"
