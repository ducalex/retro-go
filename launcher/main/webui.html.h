...
"#filebrowser{width:100%;} #filebrowser th {text-align:left;} #filebrowser th, #filebrowser tr:hover {background:#ddd}"
...
"            <thead><tr><th>Filename</th><th style='width: 80px;'>Size</th><th style='width: 125px;'>Action</th></tr></thead>"
"            <tbody></tbody>"
"        </table>"
"    </div>"
"    <hr>"
